// scripts/fdc-workflow-new-tx-fixed.js
...
// Use the new transaction hash from command line or .env
const TX_HASH = process.env.NEW_TX_HASH || "0x641978c9b626eac336323229c803e7e25a6f11a62486940e9c92ee592ec80d0f";
...
async function runWorkflow() {
  try {
    // Skip Sepolia verification since we've already created and confirmed the transaction
    console.log("Using Sepolia transaction:", TX_HASH);
    console.log("Assuming transaction is confirmed with sufficient confirmations");
    
    // Now proceed with the regular workflow
